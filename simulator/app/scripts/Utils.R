...
setGeneric("get_my_muller_plot",function(obs_Pop_ID,obs_tumor_tibble,functional_effects,freq,palette) standardGeneric("get_my_muller_plot"))
setMethod("get_my_muller_plot",
          signature(obs_Pop_ID="tbl",
                    obs_tumor_tibble="tbl",
          ...
          function(obs_Pop_ID,obs_tumor_tibble,functional_effects,freq,palette){
            ...
            tryCatch(expr = {
              ...
              fun_eff<-sapply(pop,function(p){paste(get_phenotype_label(p,functional_effects),collapse="_")})
